...
import type { CreditCardViewMode } from "@/lib/credit-card-view-storage";

const VIEW_OPTIONS: readonly {
  value: CreditCardViewMode;
  label: string;
...
interface CreditCardViewToggleProps {
  value: CreditCardViewMode;
  onChange: (value: CreditCardViewMode) => void;
  className?: string;
}

export function CreditCardViewToggle({ value, onChange, className }: CreditCardViewToggleProps) {
